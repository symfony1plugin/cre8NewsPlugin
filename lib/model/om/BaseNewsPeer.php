...
abstract class BaseNewsPeer {
	...
	const CLASS_DEFAULT = 'plugins.cre8NewsPlugin.lib.model.News';
	...
	const DISPLAY_DATE = 'news.DISPLAY_DATE';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NewsPeer::SLUG);

		$criteria->addSelectColumn(NewsPeer::DISPLAY_DATE);
    ...
    foreach (sfMixer::getCallables('BaseNewsPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseNewsPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseNewsPeer', $criteria, $con);
    }

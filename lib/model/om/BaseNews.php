...
abstract class BaseNews extends BaseObject  implements Persistent {
  ...
  const PEER = 'NewsPeer';
	...
	public function setSlug($v)
	{
		...
		if ($this->slug !== $v) {
			$this->slug = $v;
			$this->modifiedColumns[] = NewsPeer::SLUG;
		}
	...
	public function setDisplayDate($v)
	{
		...
		if ( $this->display_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = NewsPeer::DISPLAY_DATE;
			}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(NewsPeer::IS_ACTIVE))) {
				return false;
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::SLUG)) $criteria->add(NewsPeer::SLUG, $this->slug);
		if ($this->isColumnModified(NewsPeer::DISPLAY_DATE)) $criteria->add(NewsPeer::DISPLAY_DATE, $this->display_date);
